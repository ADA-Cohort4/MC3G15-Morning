...
public class HorizontalCalendar: UIView {
    ...
    static var selectedColor = UIColor.blueAccent
    static var todayColor = UIColor.blueAccent
    static var textDark = UIColor.obsidian
    static var textLight = UIColor.systemBlue
    static var dateColor = UIColor.systemBlue

    let border = UIColor.systemBlue
